    ...
    function showOptInConfirmation(formData) {
        ...
        messageEl.innerHTML = `
            <div style="text-align: left;">
                ...
                <p style="margin-bottom: 0.75rem;"><strong>Program Description:</strong> You are now enrolled in the RIOS LLC VIP List program. You will receive text messages containing early access notifications to exclusive opportunities, promotional offers, special deals, updates about new products and services, and transactional messages related to your account.</p>
